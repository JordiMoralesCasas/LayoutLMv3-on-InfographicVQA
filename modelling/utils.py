...
def get_optimizers(model: nn.Module, learning_rate: float, num_training_steps: int, weight_decay:float = 0.01,
    ...
    # Declare which parameters will use weight_decay
    ...
    # TODO: Also, we can merge warmup_step and warmup_ratio into one parameter. If user input a number 0 <= x < 1, it will be
    # considered as warmup_ratio. If user input an interger, it will be considered as warmup_step.
    # Change warmup_step parameter 
    #warmup_ratio = 0.1
    #warmup_step = num_training_steps*warmup_ratio
